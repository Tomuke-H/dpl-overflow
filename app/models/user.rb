...
def self.user_answers(id)
  select('u.id, q.id AS ques_id, a.question_id AS question_id, a.id AS answer_id, q.title, q.body AS question_body, q.views, a.body AS answer_body, a.created_at AS answer_created, q.created_at AS question_created')
  .from('answers AS a')
